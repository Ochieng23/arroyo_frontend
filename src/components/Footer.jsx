    ...
    social: [
      {
        ...
        icon: (props) => (
          <svg
            ...
            aria-hidden="true"
          >
            <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89h1.26v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
          </svg>
        ),
      },
      {
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        ...
        <div className="xl:grid xl:grid-cols-4 xl:gap-8">
          ...
          <div className="space-y-8">
            ...
            />
            <p className="text-sm">
              Empowering creators to unlock their full potential with innovative
              tools.
            </p>
          ...
          <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 xl:col-span-3 xl:mt-0">
            {["solutions", "support", "company", "legal"].map((category) => (
              <div key={category}>
        ...
        <div className="mt-16 border-t border-gray-700 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-sm text-gray-400">
            &copy; 2024 Loreax, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
